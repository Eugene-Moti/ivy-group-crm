    ...
    <div className="flex h-full min-h-0 flex-col rounded-xl border border-border bg-card">
      <div className="border-b border-border p-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold text-foreground">Ask Orion</h2>
        </div>
        <p className="mt-1.5 text-xs text-muted-foreground">
          Talk through the pipeline, individual leads, or what to do next — grounded in live CRM data.
          {isAdmin && " Orion can draft changes too, but nothing is applied until you confirm it."}
        </p>
      </div>

      <ScrollArea className="min-h-0 flex-1 px-4">
        <div ref={scrollRef} className="flex h-full flex-col gap-3 py-4">
          {messages.length === 0 && (
