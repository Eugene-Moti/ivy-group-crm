...
export const IMPORT_FIELDS: ImportFieldConfig[] = [
  ...
  { key: "property_type", label: "Project", required: false, aliases: ["project", "property type", "type", "property", "development"] },
  { key: "preferred_area", label: "Location", required: false, aliases: ["location", "preferred area", "preferred location", "area", "neighborhood", "neighbourhood"] },
